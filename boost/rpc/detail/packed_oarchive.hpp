...
// (C) Copyright 2012 Christian Holmquist
...
// Original file: boost/mpi/packed_oarchive.hpp
// 2012 Christian Holmquist - Removed dependencies on Boost.MPI.
 ...
 */
#ifndef BOOST_RPC_PACKED_OARCHIVE_HPP
#define BOOST_RPC_PACKED_OARCHIVE_HPP

#include <boost/archive/detail/auto_link_archive.hpp>
#include <boost/archive/detail/common_oarchive.hpp>
#include <boost/archive/shared_ptr_helper.hpp>
#include <boost/rpc/detail/binary_buffer_oprimitive.hpp>
...
class BOOST_RPC_DECL packed_oarchive
  : public oprimitive
...
public:
  ...
  packed_oarchive ( unsigned int flags =  boost::archive::no_header)
...
#endif // BOOST_RPC_PACKED_OARCHIVE_HPP
